...
@Disabled
public class CloseRedSENSINGOption extends CompetitionAutoOpMode {
    ...
    public CloseRedSENSINGOption(OpMode parentOpMode) {
        super(parentOpMode);
    }

    double TowerGoalPosition;
    ...
    public void init() {
        ...
        TowerGoalPosition = (RobotComponents.tower_motor.getCurrentPosition() - 1288);
...
// LEFT
    ...
    @Override
    void loop() {
        RobotComponents.tickSystems(op);
    }
}
